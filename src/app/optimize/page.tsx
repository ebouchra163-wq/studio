...
export default function OptimizePage() {
  ...
  return (
    <div className="container mx-auto max-w-4xl py-12">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Parámetros de Ruta</CardTitle>
          <CardDescription>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="ej., Nueva York, NY" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="ej., Los Ángeles, CA" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="ej., Chicago, IL (uno por línea)"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                      Introduzca las paradas intermedias, una por línea.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="ej., Cielos despejados, 24°C" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="ej., Entregar antes del 30 de julio, 5:00 PM"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
