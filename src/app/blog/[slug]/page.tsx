...
import { getPostBySlug, posts, type Post } from '@/lib/blog-posts';
...
// Although this is a client component, Next.js will still use 
// generateStaticParams during the build process on the server.
